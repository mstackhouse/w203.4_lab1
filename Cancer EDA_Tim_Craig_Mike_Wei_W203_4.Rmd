...
par(mfrow=c(1,3))
hist(df$PctPrivateCoverage,breaks = seq(20,95,by=5), main = "PctPrivateCoverage Hist")

hist(df$PctEmpPrivCoverage,breaks = seq(10,75,by=5), main = "PctEmpPrivCoverage Hist")

hist(df$PctPublicCoverage,breaks = seq(10,70,by=5), main = "PctPublicCoverage Hist")
```

```{r}
qplot(df$PctPublicCoverage, geom="histogram", binwidth = 2, fill=I("white"), col=I("blue"), main = "PctPublicCoverage Hist") 
```
...
```{r}
cor(df$deathRate, df$PctPrivateCoverage)
